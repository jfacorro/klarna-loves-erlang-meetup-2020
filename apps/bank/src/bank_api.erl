...
request_params('CreateAccountHolder') ->
    [
        'AccountHolderRequest'
    ];

request_params('CreateTransfer') ->
    [
        'TransferRequest'
    ];
...
request_params('GetAccountHolder') ->
    [
        'id'
    ];

request_params('GetTransfer') ->
    [
        'id'
    ];

request_params('Healthcheck') ->
    [
    ];
...
request_param_info('CreateAccount', 'AccountRequest') ->
    #{
        source =>   body,
        rules => [
            schema,
...
request_param_info('CreateAccountHolder', 'AccountHolderRequest') ->
    #{
        source =>   body,
        rules => [
            schema,
...
request_param_info('CreateTransfer', 'TransferRequest') ->
    #{
        source =>   body,
        rules => [
            schema,
...
request_param_info('GetAccountHolder', 'id') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'binary'},
...
request_param_info('GetTransfer', 'id') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'binary'},
...
request_param_info('UpdateTransfer', 'id') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'binary'},
...
request_param_info('UpdateTransfer', 'TransferUpdateRequest') ->
    #{
        source =>   body,
        rules => [
            schema,
...
validate_response('CreateAccount', 200, Body, ValidatorState) ->
    validate_response_body('AccountResponse', 'AccountResponse', Body, ValidatorState);
validate_response('CreateAccount', 0, Body, ValidatorState) ->
    validate_response_body('FailureResponse', 'FailureResponse', Body, ValidatorState);

validate_response('CreateAccountHolder', 200, Body, ValidatorState) ->
    validate_response_body('AccountHolderResponse', 'AccountHolderResponse', Body, ValidatorState);
validate_response('CreateAccountHolder', 0, Body, ValidatorState) ->
    validate_response_body('FailureResponse', 'FailureResponse', Body, ValidatorState);

validate_response('CreateTransfer', 200, Body, ValidatorState) ->
    validate_response_body('TransferResponse', 'TransferResponse', Body, ValidatorState);
validate_response('CreateTransfer', 0, Body, ValidatorState) ->
    validate_response_body('FailureResponse', 'FailureResponse', Body, ValidatorState);
...
validate_response('GetAccountHolder', 200, Body, ValidatorState) ->
    validate_response_body('AccountHolderResponse', 'AccountHolderResponse', Body, ValidatorState);
validate_response('GetAccountHolder', 0, Body, ValidatorState) ->
    validate_response_body('FailureResponse', 'FailureResponse', Body, ValidatorState);

validate_response('GetTransfer', 200, Body, ValidatorState) ->
    validate_response_body('TransferResponse', 'TransferResponse', Body, ValidatorState);
validate_response('GetTransfer', 0, Body, ValidatorState) ->
    validate_response_body('FailureResponse', 'FailureResponse', Body, ValidatorState);

validate_response('Healthcheck', 200, Body, ValidatorState) ->
    validate_response_body('HealthcheckResponse', 'HealthcheckResponse', Body, ValidatorState);

validate_response('Ping', 204, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);

validate_response('UpdateTransfer', 200, Body, ValidatorState) ->
    validate_response_body('TransferResponse', 'TransferResponse', Body, ValidatorState);
validate_response('UpdateTransfer', 0, Body, ValidatorState) ->
    validate_response_body('FailureResponse', 'FailureResponse', Body, ValidatorState);
...
validate(Rule = schema, Name, Value, ValidatorState) ->
    Definition =  list_to_binary("#/components/schemas/" ++ bank_utils:to_list(Name)),
    try
...
get_value(qs_val, Name, Req) ->
    ...
    Value = bank_utils:get_opt(bank_utils:to_qs(Name), QS),
    {Value, Req};

get_value(header, Name, Req) ->
    Headers = cowboy_req:headers(Req),
    Value =  maps:get(bank_utils:to_header(Name), Headers, undefined),
    {Value, Req};

get_value(binding, Name, Req) ->
    Value = cowboy_req:binding(bank_utils:to_binding(Name), Req),
    {Value, Req}.
...
binary_to_lower(V) when is_binary(V) ->
    list_to_binary(string:to_lower(bank_utils:to_list(V))).
