...
validate_response('createAccount', 201, Body, ValidatorState) ->
...
validate_response('createAccountHolder', 201, Body, ValidatorState) ->
...
validate_response('createAccountHolder', 0, Body, ValidatorState) ->
    validate_response_body('FailureResponse', 'FailureResponse', Body, ValidatorState);
validate_response('createTransfer', 201, Body, ValidatorState) ->
...
request_param_info('createAccount', 'AccountRequest') ->
    #{
        source => body,
        rules => [
            {schema, object, <<"#/components/schemas/AccountRequest">>},
            required
        ]
    };
request_param_info('createAccountHolder', 'AccountHolderRequest') ->
    #{
        source => body,
        rules => [
            {schema, object, <<"#/components/schemas/AccountHolderRequest">>},
            required
        ]
    };
request_param_info('createTransfer', 'TransferRequest') ->
    #{
        source => body,
        rules => [
            {schema, object, <<"#/components/schemas/TransferRequest">>},
            required
        ]
    };
...
request_param_info('updateTransfer', 'TransferUpdateRequest') ->
    #{
        source => body,
        rules => [
            {schema, object, <<"#/components/schemas/TransferUpdateRequest">>},
            required
        ]
    };
