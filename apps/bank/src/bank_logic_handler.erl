...
-callback handle_request(OperationID :: bank_api:operation_id(), cowboy_req:req(), Context :: context()) ->
    handler_response().
...
-spec authorize_api_key(Handler :: atom(), OperationID :: bank_api:operation_id(), ApiKey :: binary()) ->
    Result :: false.
