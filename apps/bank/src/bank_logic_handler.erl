...
-type api_key_callback() ::
    fun((bank_api:operation_id(), binary()) -> {true, context()} | {false, iodata()}).
-type accept_callback() ::
    fun((bank_api:class(), bank_api:operation_id(), cowboy_req:req(), context()) ->
...
-callback api_key_callback(bank_api:operation_id(), binary()) ->
    {true, context()} | {false, iodata()}.

-callback accept_callback(bank_api:class(), bank_api:operation_id(), cowboy_req:req(), context()) ->
    {accept_callback_return(), cowboy_req:req(), context()}.

-callback provide_callback(bank_api:class(), bank_api:operation_id(), cowboy_req:req(), context()) ->
    {cowboy_req:resp_body(), cowboy_req:req(), context()}.
...
-spec api_key_callback(bank_api:operation_id(), binary()) -> {true, #{}}.
...
-spec accept_callback(bank_api:class(), bank_api:operation_id(), cowboy_req:req(), context()) ->
    {accept_callback_return(), cowboy_req:req(), context()}.
...
-spec provide_callback(bank_api:class(), bank_api:operation_id(), cowboy_req:req(), context()) ->
    {cowboy_req:resp_body(), cowboy_req:req(), context()}.
